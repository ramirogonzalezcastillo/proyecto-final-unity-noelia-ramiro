...
public class Enemies : MonoBehaviour
{
    ...
    enum EnemiesTypes { Crawler, Stalker, Rioter };

    //Creamos entonces una propiedad del tipo de enumeración creada.
    [SerializeField] EnemiesTypes enemiesType;
    ...
    void Update()
    {
        ...
        switch (enemiesType)
        {
            case EnemiesTypes.Crawler:
                Invoke("CrawlerMove", runDelay);
                break;
            case EnemiesTypes.Stalker:
                ChasePlayer();
                break;
            case EnemiesTypes.Rioter:
                RotateAroundPlayer();
                break;
        }
    }
